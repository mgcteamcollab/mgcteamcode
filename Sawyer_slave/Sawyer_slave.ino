...
void setup()
{
  ...
  Wire.begin(12);                // join i2c bus with address #23
...
void loop()
{
  ...
  pressures[0].fval = pressureFunction(0);
  pressures[1].fval = pressureFunction(1);
  pressures[2].fval = pressureFunction(2);
  pressures[3].fval = pressureFunction(3);
  pressures[4].fval = pressureFunction(6);
  pressures[5].fval = pressureFunction(7);
  flows[0].fval = flowRate(9);
  flows[1].fval = flowRate(8);
  flows[2].fval = flowRate(7);
  flows[3].fval = flowRate(6);
  flows[4].fval = flowRate(5);
  flows[5].fval = flowRate(4);
